...
const BROKER_DOCS = {
  ...
  tradelocker: {
    name: "TradeLocker",
    description: "Connect your TradeLocker account for automated forex/CFD trading",
    setup: [
      "Go to Settings > Accounts and click 'Add Account'",
      "Select 'TradeLocker' as the broker",
      "Enter your TradeLocker email and password",
      "Select the account from the discovered accounts list",
      "Save the account",
    ],
    orderTypes: [
      { name: "Market Buy", supported: true, example: '{"ticker": "EURUSD", "action": "buy", "quantity": 0.01}' },
      { name: "Market Sell", supported: true, example: '{"ticker": "EURUSD", "action": "sell", "quantity": 0.01}' },
      ...
      { name: "Close Position", supported: true, example: '{"ticker": "EURUSD", "action": "close"}' },
      { name: "Close All", supported: true, example: '{"action": "close_all"}' },
      { name: "Modify SL/TP", supported: true, example: '{"ticker": "EURUSD", "action": "modify", "sl": 1.0800, "tp": 1.0950}' },
      { name: "Trailing Stop", supported: true, example: '{"ticker": "EURUSD", "action": "modify", "trailing_stop": 50}' },
    ],
    fields: {
      ticker: "Symbol/ticker name (e.g., EURUSD, XAUUSD, BTCUSD)",
      quantity: "Position size in lots (0.01 = micro lot)",
      sl: "Stop loss price level",
      tp: "Take profit price level",
    ...
    notes: [
      "TradeLocker uses OAuth authentication",
      "Session tokens refresh automatically",
      "Symbol names are typically uppercase without suffixes",
    ],
  },
  projectx: {
