...
import { Lock, Crown, ArrowRight, Sparkles, BarChart3, Timer, Shield, LineChart, TestTube } from 'lucide-react';
import Link from 'next/link';
import { TabContainer } from '@/components/smartflow/TabContainer';
import { EngineStatusBadges } from '@/components/smartflow/EngineStatusBadges';
...
export default function SmartFlowPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      {/* Deterministic Analysis Dashboard (NO AI for entries) */}
      <Card className="border-2 border-green-500/20 bg-gradient-to-br from-green-500/5 to-emerald-500/5">
        <CardHeader>
          ...
          <CardDescription>
            Multi-timeframe indicators, volume analysis, latency tracking, and Polygon options flow
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {/* SmartFlow Elite Dashboard - Quant Analytics */}
      <Card className="border-2 border-yellow-500/20 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            SmartFlow Elite Analytics
            <Badge className="bg-gradient-to-r from-yellow-500 to-orange-600 text-white">
              QUANT 2026
            </Badge>
          </CardTitle>
          <CardDescription>
            Regime detection, CVaR risk metrics, feature importance, and performance analytics
          </CardDescription>
        </CardHeader>
        <CardContent>
          <EliteDashboard />
      ...
      {/* Forward Test Dashboard - Live Paper Trading with Full Audit Trail */}
      <Card className="border-2 border-cyan-500/20 bg-gradient-to-br from-cyan-500/5 to-blue-500/5">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            <Badge className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white animate-pulse">
              LIVE
            </Badge>
          </CardTitle>
          <CardDescription>
      ...
      <Card className="border-2 border-violet-500/20 bg-gradient-to-br from-violet-500/5 to-purple-500/5">
        <CardHeader>
          ...
          <CardDescription>
            Machine learning insights and AI analysis history (for signal enhancement only)
          </CardDescription>
        </CardHeader>
        <CardContent>
