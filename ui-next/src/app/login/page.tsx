              ...
              {isGoogleEnabled && (
                <div className="w-full">
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full flex items-center justify-center gap-2 py-3 bg-gray-900/50 border border-gray-600 rounded-lg text-gray-300 hover:bg-gray-800/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
