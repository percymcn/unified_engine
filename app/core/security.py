...
def generate_webhook_key() -> str:
    """Generate random webhook key"""
    return secrets.token_urlsafe(24)


# Note: get_current_user and verify_api_key are defined in routers/auth.py
# They are imported from there to avoid circular imports
